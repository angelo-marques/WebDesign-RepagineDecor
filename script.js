...
! function (a) {
    ...
    e.TRANSITION_DURATION = 350, e.DEFAULTS = {
        ...
        if (!this.transitioning && !f.hasClass("in")) {
            ...
            return d ? void f.one("mmTransitionEnd", a.proxy(h, this)).emulateTransitionEnd(e.TRANSITION_DURATION).height(function () {
                try {
...
//ANIMATIONS
//Initialize the animation with the main settings
...
//Scroll the page to target object
...
//Generate the array of options of the plugins by the HTML string
...
function isEmpty(obj) {
    if (typeof (obj) !== "undefined" && obj !== null && (obj.length > 0 || typeof (obj) == 'number' || typeof (obj.length) == "undefined") && obj !== "undefined") return false;
    else return true;
}
//Convert a text string to a booliean, number, or string
function correctValue(n) {
    return typeof n == "number" ? parseFloat(n) : n == "true" ? !0 : n == "false" ? !1 : n
}
//Check if the target item is visible in the user's browser
...
(function ($) {
    ...
    //Set the title to fullscreen size
    $.fn.titleFullScreen = function (h) {
        ...
        //Set the height of target as the screen height
    $.fn.sizeFullScreen = function (h) {
        ...
        //Position middle related to container for target object
    ...
    //Expand a container with a animation
    ...
    //Collapse a container with a animation
    ...
    $(document).ready(function () {
        ...
        function showSublineMenu(item) {
            ...
            $(t).css("opacity", "0").css("display", "block").animate({
                "opacity": 1
            }, 300);
        }
